...
const ROLE_ABILITIES = {
  ...
  engineer: "每局一次，在夜晚选择本局在场的是哪些爪牙，或是哪一种恶魔。",
  fisherman:
  ...
  huntsman:
    "每局一次，在夜晚选择一名存活玩家；若其是落难少女，她会变成一个不在场的镇民。[+落难少女]",
  atheist:
    "说书人可以违反游戏规则；若说书人被处决，善良方获胜，即使你已死亡。[无邪恶角色]",
  "poppy-grower": "爪牙和恶魔互不认识。如果你死亡，当晚他们会互相认识。",
  mutant:
    "如果你疯狂地表现出自己是外来者，你可能被处决。",
  puzzlemaster:
    "一名玩家醉酒，即使你死亡仍然如此。你每局可猜一次谁醉酒；猜对得知恶魔玩家，猜错得到错误信息。",
  sweetheart: "当你死亡时，一名玩家从此醉酒。",
  golem: "你每局只能提名一次。你提名时，若被提名者不是恶魔，他立刻死亡。",
  barber:
    "如果你死亡，恶魔可以选择两名玩家交换角色，但不能选择另一个恶魔。",
  damsel:
    "所有爪牙都知道场上有落难少女。若一名爪牙公开猜中你（全局一次），善良方失败。",
  klutz:
  ...
  psychopath:
    "每个白天，在提名开始前，你可以公开选择一名玩家：其死亡。如果你被处决，只有在猜拳输给提名者时你才会死亡。",
  kazali:
    "每晚*选择一名玩家死亡。开局时由你选择哪些玩家成为哪些爪牙，外来者数量可能调整。",
  ojo:
    "每晚*选择一个角色；若该角色在场，该角色玩家死亡。若不在场，由说书人选择谁死亡。",
  "al-hadikhia":
    "每晚*你可以选择三名玩家（所有人都会得知是谁）；他们依次暗中选择生或死，但若三人都选择生，则三人全都死亡。",

  pixie:
    "首夜得知一个在场镇民角色。如果你疯狂地表现为该角色，并且该角色死亡，你获得该角色能力。",
  snitch:
    "首夜所有爪牙分别得知三个不在场角色。",
  legion:
    "每晚*可能有一名玩家死亡。若提名只得到邪恶玩家投票，投票无效。多数玩家是军团，且军团也被当作爪牙。",
  shugenja:
    "首夜得知距离最近的邪恶玩家在你的顺时针或逆时针方向；若两边等距，由说书人决定方向。",
  preacher:
    "每晚选择一名玩家。如果选中爪牙，该爪牙得知被传教士选中，且所有被你选中过的爪牙失去能力。",
  "plague-doctor":
    "如果你死亡，说书人获得一个不在场爪牙的能力。",
  "lil-monsta":
    "每晚所有爪牙秘密决定由哪名玩家照看小怪宝并成为恶魔。每晚*会有一名玩家死亡。场上增加一名爪牙。",
...
const ADDITIONAL_ROLES = [
  ...
  role("noble", "贵族", "townsfolk", "midnight-oasis", "首夜锁定三名玩家，其中恰有一人邪恶，是早期缩圈但难以直接坐实的稳定信息位。", "首夜 三选一 邪恶 信息"),
  ...
  role("engineer", "工程师", "townsfolk", "midnight-oasis", "一次性重写在场恶魔或爪牙配置，能直接扭转威胁结构，也会让整桌重新评估局势。", "换恶魔 换爪牙 一次性 配置"),
  ...
  role("huntsman", "巡山人", "townsfolk", "midnight-oasis", "夜晚一次性寻找落难少女，命中后可把她变成不在场镇民，是对抗落难少女输法的关键功能位。", "落难少女 一次性 变镇民 夜晚"),
  role("atheist", "无神论者", "townsfolk", "midnight-oasis", "把整局目标改成处决说书人，要求玩家从全局不一致中判断这是不是一局没有邪恶的游戏。", "无邪恶 处决说书人 特殊胜利 规则"),
  role("poppy-grower", "罂粟种植者", "townsfolk", "midnight-oasis", "让恶魔与爪牙开局互不相认，直到自己死亡才恢复邪恶方协作，是强力的前期信息封锁位。", "邪恶不互认 死亡触发 信息封锁"),
  ...
  role("golem", "魔像", "outsider", "midnight-oasis", "整局只能提名一次，但若提到的不是恶魔会立刻杀死对方，制造极高风险的白天突破。", "白天 提名 一次性 处决"),
  role("barber", "理发师", "outsider", "sects-and-violets", "死亡后恶魔可能交换两名玩家的角色。", "死亡 交换 角色"),
  role("damsel", "落难少女", "outsider", "midnight-oasis", "所有爪牙都知道场上有她；若爪牙公开猜中她，善良方立刻失败，是极强的身份保密压力源。", "外来者 公开猜测 失败条件 保密"),
  ...
  role("psychopath", "精神病患者", "minion", "midnight-oasis", "可在提名前公开杀人，被处决时还可能靠猜拳活下，是会持续挤压白天节奏的公开爪牙。", "白天击杀 公开 猜拳 免死"),
  ...
  role("al-hadikhia", "哈迪寂亚", "demon", "midnight-oasis", "每晚公开点三人，在沉默中逼他们选生或死；若三人都求生则三人全死，是极高波动的多杀恶魔。", "三人 生死选择 多杀 沉默"),
  ...
  role("lil-monsta", "小怪宝", "demon", "dao-guang-jian-ying", "由爪牙每晚秘密决定谁照看并成为恶魔，隐藏真正恶魔归属。", "恶魔 爪牙 照看 隐藏"),
